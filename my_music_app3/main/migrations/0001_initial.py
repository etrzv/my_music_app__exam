...
import my_music_app3.main.validators
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=15, validators=[my_music_app3.main.validators.validate_if_username_contains_letters_numbers_and_underscores, django.core.validators.MinLengthValidator(2)])),
